...
for i,v in pairs(lighting:GetChildren()) do 
    ...
    local Bloom = lighting:FindFirstChild("BladeShaders_Bloom") or Instance.new("BloomEffect", lighting)
    local ColorCorrection = lighting:FindFirstChild("BladeShaders_ColorCorrection") or Instance.new("ColorCorrectionEffect", lighting)
    ...
    Bloom.Name = "BladeShaders_Bloom"
    Bloom.Intensity = 0.1 
    Bloom.Size = 46
    Bloom.Threshold = 0.8
    ColorCorrection.Name = "BladeShaders_ColorCorrection"
